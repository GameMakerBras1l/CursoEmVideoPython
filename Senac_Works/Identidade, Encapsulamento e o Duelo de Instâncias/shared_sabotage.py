...
class Fighter:
    ...
    inventory = []
    # ⚠️ ERRO: inventory é um atributo de CLASSE
    ...
    def pick_item(self, item):
        ...
        # ⚠️ Como inventory é compartilhado, todos os objetos são afetados
...
if __name__ == "__main__":
    ...
    # ⚠️ Aqui aparece o erro:
    # Sub-Zero já tem "Spear" mesmo sem ter pegado nada
